package com.ardacolak.fotografpaylasma.adapter

import android.view.LayoutInflater
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import com.ardacolak.fotografpaylasma.databinding.RecyclerRowBinding
...
class PostAdapter (private val postList : ArrayList<Post>) : RecyclerView.Adapter<PostAdapter.PostHolder>() {
    ...
    override fun onBindViewHolder(holder: PostHolder, position: Int) {
        ...
        Picasso.get().load(postList[position].downlandUrl).into(holder.binding.recyclerImageView)
